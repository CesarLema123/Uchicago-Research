...
class PolymerDataManager:
    ...
    Attributes:
        df = pandas DataFrame object, contains data from the input file.
        
        experimental_descriptors = [str], collection of experimental thermo-physical properties in data
        
        chemical_descriptors = [str], a small collection of some available descriptors from rdkit descriptors module
